...
class ImageDatasetManager:
    ...
    def preprocess(self,
        ...
        if not self._dsm.is_created:
            ...
            for handler in self._handlers:
                ...
                split_idx = int(split_ratio * len(list_))
            ...
            for idx, raw_train_img_path in enumerate(raw_train_img_path_list):
                ...
                img = self._process_image(img, dst_shape)
    ...
    def load_train_batch(self,
        ...
        :return: list of train images (batch_size, width, height, channels)
        """
        ...
        if randomize:
            ...
            images = [cv2.imread(self._train_img_path_list[r_idx]) for r_idx in random_idx_list]
        else:
            if from_index >= len(self._train_img_path_list):
                ...
                images = [cv2.imread(img_path) for img_path in
